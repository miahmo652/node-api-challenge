...
-   [ ] Describe Middleware?
            ...
            middleware takes in request and response in order to 
            perform an action.
-   [ ] Describe a Resource?

            a resource is the data thats coming from the server

-   [ ] What can the API return to help clients know if a request was successful?
                a http status code 200 or 201 which are the success status codes

-   [ ] How can we partition our application into sub-applications?
                we can use routers from express to divide our applications into sub applications
